...
<div id="content" class="<?php echo $class; ?>">
		...
		<script>
	        ...
	        <div class="<?php echo $class; ?>">
	          ...
	          <ul class="list-unstyled myprice">
	            ...
	            <?php } else { ?>
	            <li>
	              <span class="price-new"><?php echo $special; ?></span> <span class="price-old"><?php echo $price; ?></del></span>
	            </li>
	            <?php } ?>
	            <?php if ($tax) { ?>
		...
		<div class="row row-5 knopki">
			...
			<div class="col-sm-6 col-md-2 padding-rl5">
					<button type="button" data-toggle="tooltip" class="btn btn-gray" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i></button>

			</div>
			<div class="col-sm-6 col-md-2 padding-rl5">
					<button type="button" data-toggle="tooltip" class="btn btn-gray" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i></button>
			</div>
		</div>
