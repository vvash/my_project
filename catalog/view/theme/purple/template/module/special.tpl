...
<div id="mod_special" class="row owl-carousel owl-theme" >
                ...
                <div class="modal-body">
						...
						<div class="padded">
							<?php if ($product['thumb'] || $images) { ?>
								<ul class="thumbnails">
									...
									<?php if (isset($product['thumb']) AND isset($product['image'])) { ?>
					...
					<div class="col-sm-6">
						<div class="padded">
							...
							<hr/>
							<?php if(isset($product['full_description'])){ ?>
